...
if(isset($_POST['p_submit'])){
  if (isset($_POST['client_form_nonce']) && wp_verify_nonce($_POST['client_form_nonce'], 'client_form_nonce')) {
    ...
    $to = 'custommockup@pixpine.site, innovawebdeveloper@gmail.com, harun@encoderit.net, harun.encoderit@gmail.com';
            ...
            <div class="row_d">
              <div class="request_for_mockup_col">
                <div class="heading_col">
                  ...
                  <p>
                    We recommend uploading at least 5 images of your product
            ...
            <div class="accordion right" id="accordionExampleRight">
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    <p>
                        The ownership of the customised mockups.
                        The customized mockup includes a Standard Personal and Commercial License. If you require an Exclusive License,
                        there
                        may be an additional cost.
                        To request an Exclusive License, please select the option in the form. With the Standard License, the customized
                        mockup(s) will remain the sole property of Pixpine and will be available for download on Pixpine.com under a
                        non-exclusive, royalty-free license. You will not have any ownership stake in the business generated by the
                        mockup(s).
                        For more information about licenses, <a class="primary_color" href="<?php echo site_url('license');?>">click here.</a>
                    </p>
                  </div>
                </div>
              </div>
