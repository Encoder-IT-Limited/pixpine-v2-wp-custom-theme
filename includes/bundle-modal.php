                  ...
                  <div class="mobile_">
                    <div class="price_product_specs_container">
                      <div class="add_to_cart">
                        ...
                        <?php echo is_show_download_btn($cpt->ID) ? 'download-product':'add-to-cart';?> " p-id="<?php echo $cpt->ID;?>" is-logged-in="<?php echo $is_logged_in;?>" in-cart="<?php echo $in_cart;?>" cart-url="<?php echo site_url('cart');?>" type="bundle-mockups">
                  ...
                  <div class="sticky-top">
                    ...
                    <div class="price_product_specs_container">
                      <div class="add_to_cart">
                        ...
                        <button class="_btn btn_primary 
                        <?php echo is_show_download_btn($cpt->ID, 'bundle-mockups') ? 'download-product':'add-to-cart';?> " p-id="<?php echo $cpt->ID;?>" is-logged-in="<?php echo $is_logged_in;?>" in-cart="<?php echo $in_cart;?>" cart-url="<?php echo site_url('cart');?>" type="bundle-mockups">
