                    ...
                    <?php
                      ...
                      <div class="slider__item">
                        <div class="inner__slider">
                          ...
                          <button class="slider__wishlist alter-favorite" p-id="<?php echo $cpt->ID;?>" is-favorite="<?php echo $is_favorite; ?>">
                            <?php if($is_favorite == 1){ ?>
                              <img src="<?php echo get_template_directory_uri();?>/assets/images/wishlist_icon-fill.png" alt="" />
                              <?php }else{ ?>
